...
if "Prediction Process" in data_to_show:
    ...
    st.dataframe(rmse_frame.sort_values(by="RMSE", ascending=True)\
    ...
    most_important = feat_importances.sort_values(by="0", ascending=False).head(10).sort_values(by="0", ascending=True)
